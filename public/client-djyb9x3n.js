...
// src/test/HomePage.tsx
var import_react = __toESM(require_react(), 1);
function HomePage(props) {
  const [counter, setCounter] = import_react.default.useState(0);
  ...
  return import_react.default.createElement("html", null, import_react.default.createElement("head", null, import_react.default.createElement("title", null, "Home Page")), import_react.default.createElement("body", null, import_react.default.createElement("h1", null, "Hello, world!"), import_react.default.createElement("p", null, props.message), import_react.default.createElement("p", null, "Counter: ", counter), import_react.default.createElement("button", {
    onClick: () => setCounter(counter + 1)
  }, "Increment")));
}

// src/client.tsx
client.hydrateRoot(document, import_react2.default.createElement(HomePage, null));
