...
var require_react_dom_development = __commonJS((exports) => {
  ...
  (function() {
    ...
    typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ !== "undefined" && typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart === "function" && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
    var ReactSharedInternals = import_react.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, Internals = {
      d: {
        f: noop,
        r: function() {
...
var require_react_dom_client_development = __commonJS((exports) => {
  ...
  (function() {
    ...
    function updateSuspenseComponent(current2, workInProgress2, renderLanes2) {
      ...
      (JSCompiler_object_inline_digest_2329 = didSuspend) || (JSCompiler_object_inline_digest_2329 = current2 !== null && current2.memoizedState === null ? false : (suspenseStackCursor.current & ForceSuspenseFallback) !== 0);
      JSCompiler_object_inline_digest_2329 && (JSCompiler_object_inline_componentStack_2331 = true, workInProgress2.flags &= -129);
      JSCompiler_object_inline_digest_2329 = (workInProgress2.flags & 32) !== 0;
      ...
      if (current2 === null) {
        if (isHydrating) {
          ...
          if (isHydrating) {
            ...
            JSCompiler_temp && (warnNonHydratedInstance(workInProgress2, JSCompiler_object_inline_message_2328), throwOnHydrationMismatch(workInProgress2));
          }
          JSCompiler_object_inline_message_2328 = workInProgress2.memoizedState;
          if (JSCompiler_object_inline_message_2328 !== null && (JSCompiler_object_inline_message_2328 = JSCompiler_object_inline_message_2328.dehydrated, JSCompiler_object_inline_message_2328 !== null))
        ...
        if (JSCompiler_object_inline_componentStack_2331)
          ...
          }, JSCompiler_object_inline_componentStack_2331), JSCompiler_object_inline_stack_2330 = createFiberFromFragment(JSCompiler_object_inline_stack_2330, JSCompiler_object_inline_componentStack_2331, renderLanes2, null), JSCompiler_object_inline_message_2328.return = workInProgress2, JSCompiler_object_inline_stack_2330.return = workInProgress2, JSCompiler_object_inline_message_2328.sibling = JSCompiler_object_inline_stack_2330, workInProgress2.child = JSCompiler_object_inline_message_2328, JSCompiler_object_inline_componentStack_2331 = workInProgress2.child, JSCompiler_object_inline_componentStack_2331.memoizedState = mountSuspenseOffscreenState(renderLanes2), JSCompiler_object_inline_componentStack_2331.childLanes = getRemainingWorkInPrimaryTree(current2, JSCompiler_object_inline_digest_2329, renderLanes2), workInProgress2.memoizedState = SUSPENDED_MARKER, JSCompiler_object_inline_stack_2330;
        pushPrimaryTreeSuspenseHandler(workInProgress2);
        return mountSuspensePrimaryChildren(workInProgress2, JSCompiler_object_inline_message_2328);
      }
      var prevState = current2.memoizedState;
      if (prevState !== null && (JSCompiler_object_inline_message_2328 = prevState.dehydrated, JSCompiler_object_inline_message_2328 !== null)) {
        if (didSuspend)
          workInProgress2.flags & 256 ? (pushPrimaryTreeSuspenseHandler(workInProgress2), workInProgress2.flags &= -257, workInProgress2 = retrySuspenseComponentWithoutHydrating(current2, workInProgress2, renderLanes2)) : workInProgress2.memoizedState !== null ? (reuseSuspenseHandlerOnStack(workInProgress2), workInProgress2.child = current2.child, workInProgress2.flags |= 128, workInProgress2 = null) : (reuseSuspenseHandlerOnStack(workInProgress2), JSCompiler_object_inline_componentStack_2331 = JSCompiler_object_inline_stack_2330.fallback, JSCompiler_object_inline_message_2328 = workInProgress2.mode, JSCompiler_object_inline_stack_2330 = mountWorkInProgressOffscreenFiber({
            mode: "visible",
            children: JSCompiler_object_inline_stack_2330.children
          }, JSCompiler_object_inline_message_2328), JSCompiler_object_inline_componentStack_2331 = createFiberFromFragment(JSCompiler_object_inline_componentStack_2331, JSCompiler_object_inline_message_2328, renderLanes2, null), JSCompiler_object_inline_componentStack_2331.flags |= 2, JSCompiler_object_inline_stack_2330.return = workInProgress2, JSCompiler_object_inline_componentStack_2331.return = workInProgress2, JSCompiler_object_inline_stack_2330.sibling = JSCompiler_object_inline_componentStack_2331, workInProgress2.child = JSCompiler_object_inline_stack_2330, reconcileChildFibers(workInProgress2, current2.child, null, renderLanes2), JSCompiler_object_inline_stack_2330 = workInProgress2.child, JSCompiler_object_inline_stack_2330.memoizedState = mountSuspenseOffscreenState(renderLanes2), JSCompiler_object_inline_stack_2330.childLanes = getRemainingWorkInPrimaryTree(current2, JSCompiler_object_inline_digest_2329, renderLanes2), workInProgress2.memoizedState = SUSPENDED_MARKER, workInProgress2 = JSCompiler_object_inline_componentStack_2331);
        else if (pushPrimaryTreeSuspenseHandler(workInProgress2), isHydrating && error$jscomp$0("We should not be hydrating here. This is a bug in React. Please file a bug."), JSCompiler_object_inline_message_2328.data === SUSPENSE_FALLBACK_START_DATA) {
          ...
          JSCompiler_object_inline_digest_2329 = JSCompiler_object_inline_componentStack_2331 === undefined ? null : JSCompiler_object_inline_componentStack_2331;
          typeof JSCompiler_object_inline_digest_2329 === "string" && CapturedStacks.set(JSCompiler_object_inline_message_2328, JSCompiler_object_inline_digest_2329);
          queueHydrationError({
        ...
        } else if (JSCompiler_object_inline_digest_2329 = (renderLanes2 & current2.childLanes) !== 0, didReceiveUpdate || JSCompiler_object_inline_digest_2329) {
          JSCompiler_object_inline_digest_2329 = workInProgressRoot;
          if (JSCompiler_object_inline_digest_2329 !== null) {
            JSCompiler_object_inline_stack_2330 = renderLanes2 & -renderLanes2;
            if ((JSCompiler_object_inline_stack_2330 & SyncUpdateLanes) !== 0)
            ...
            JSCompiler_object_inline_stack_2330 = (JSCompiler_object_inline_stack_2330 & (JSCompiler_object_inline_digest_2329.suspendedLanes | renderLanes2)) !== 0 ? 0 : JSCompiler_object_inline_stack_2330;
            if (JSCompiler_object_inline_stack_2330 !== 0 && JSCompiler_object_inline_stack_2330 !== prevState.retryLane)
              throw prevState.retryLane = JSCompiler_object_inline_stack_2330, enqueueConcurrentRenderForLane(current2, JSCompiler_object_inline_stack_2330), scheduleUpdateOnFiber(JSCompiler_object_inline_digest_2329, current2, JSCompiler_object_inline_stack_2330), SelectiveHydrationException;
          }
          JSCompiler_object_inline_message_2328.data === SUSPENSE_PENDING_START_DATA || renderDidSuspendDelayIfPossible();
          workInProgress2 = retrySuspenseComponentWithoutHydrating(current2, workInProgress2, renderLanes2);
        } else
          JSCompiler_object_inline_message_2328.data === SUSPENSE_PENDING_START_DATA ? (workInProgress2.flags |= 128, workInProgress2.child = current2.child, workInProgress2 = retryDehydratedSuspenseBoundary.bind(null, current2), JSCompiler_object_inline_message_2328._reactRetry = workInProgress2, workInProgress2 = null) : (current2 = prevState.treeContext, nextHydratableInstance = getNextHydratable(JSCompiler_object_inline_message_2328.nextSibling), hydrationParentFiber = workInProgress2, isHydrating = true, hydrationErrors = null, didSuspendOrErrorDEV = false, hydrationDiffRootDEV = null, rootOrSingletonContext = false, current2 !== null && (warnIfNotHydrating(), idStack[idStackIndex++] = treeContextId, idStack[idStackIndex++] = treeContextOverflow, idStack[idStackIndex++] = treeContextProvider, treeContextId = current2.id, treeContextOverflow = current2.overflow, treeContextProvider = workInProgress2), workInProgress2 = mountSuspensePrimaryChildren(workInProgress2, JSCompiler_object_inline_stack_2330.children), workInProgress2.flags |= 4096);
        return workInProgress2;
      }
      if (JSCompiler_object_inline_componentStack_2331)
        return reuseSuspenseHandlerOnStack(workInProgress2), JSCompiler_object_inline_componentStack_2331 = JSCompiler_object_inline_stack_2330.fallback, JSCompiler_object_inline_message_2328 = workInProgress2.mode, JSCompiler_temp = current2.child, instance = JSCompiler_temp.sibling, JSCompiler_object_inline_stack_2330 = createWorkInProgress(JSCompiler_temp, {
          mode: "hidden",
          children: JSCompiler_object_inline_stack_2330.children
        }), JSCompiler_object_inline_stack_2330.subtreeFlags = JSCompiler_temp.subtreeFlags & 31457280, instance !== null ? JSCompiler_object_inline_componentStack_2331 = createWorkInProgress(instance, JSCompiler_object_inline_componentStack_2331) : (JSCompiler_object_inline_componentStack_2331 = createFiberFromFragment(JSCompiler_object_inline_componentStack_2331, JSCompiler_object_inline_message_2328, renderLanes2, null), JSCompiler_object_inline_componentStack_2331.flags |= 2), JSCompiler_object_inline_componentStack_2331.return = workInProgress2, JSCompiler_object_inline_stack_2330.return = workInProgress2, JSCompiler_object_inline_stack_2330.sibling = JSCompiler_object_inline_componentStack_2331, workInProgress2.child = JSCompiler_object_inline_stack_2330, JSCompiler_object_inline_stack_2330 = JSCompiler_object_inline_componentStack_2331, JSCompiler_object_inline_componentStack_2331 = workInProgress2.child, JSCompiler_object_inline_message_2328 = current2.child.memoizedState, JSCompiler_object_inline_message_2328 === null ? JSCompiler_object_inline_message_2328 = mountSuspenseOffscreenState(renderLanes2) : (JSCompiler_temp = JSCompiler_object_inline_message_2328.cachePool, JSCompiler_temp !== null ? (instance = CacheContext._currentValue, JSCompiler_temp = JSCompiler_temp.parent !== instance ? { parent: instance, pool: instance } : JSCompiler_temp) : JSCompiler_temp = getSuspendedCache(), JSCompiler_object_inline_message_2328 = {
          baseLanes: JSCompiler_object_inline_message_2328.baseLanes | renderLanes2,
          cachePool: JSCompiler_temp
        }), JSCompiler_object_inline_componentStack_2331.memoizedState = JSCompiler_object_inline_message_2328, JSCompiler_object_inline_componentStack_2331.childLanes = getRemainingWorkInPrimaryTree(current2, JSCompiler_object_inline_digest_2329, renderLanes2), workInProgress2.memoizedState = SUSPENDED_MARKER, JSCompiler_object_inline_stack_2330;
      pushPrimaryTreeSuspenseHandler(workInProgress2);
      ...
      current2 !== null && (JSCompiler_object_inline_digest_2329 = workInProgress2.deletions, JSCompiler_object_inline_digest_2329 === null ? (workInProgress2.deletions = [current2], workInProgress2.flags |= 16) : JSCompiler_object_inline_digest_2329.push(current2));
    ...
    (function() {
      ...
      if (isomorphicReactPackageVersion !== "19.0.0-rc-fb9a90fa48-20240614")
...
var require_react_jsx_dev_runtime_development = __commonJS((exports) => {
  ...
  (function() {
    ...
    function getComponentNameFromType(type) {
      ...
      if (typeof type === "object")
        switch (typeof type.tag === "number" && error("Received an unexpected object in getComponentNameFromType(). This is likely a bug in React. Please file an issue."), type.$$typeof) {
          case REACT_CONTEXT_TYPE:
            return (type.displayName || "Context") + ".Provider";
          case REACT_CONSUMER_TYPE:
            return (type._context.displayName || "Context") + ".Consumer";
    ...
    function checkKeyStringCoercion(value) {
      ...
      if (JSCompiler_inline_result)
        return JSCompiler_inline_result = typeof Symbol === "function" && Symbol.toStringTag && value[Symbol.toStringTag] || value.constructor.name || "Object", error("The provided key is an unsupported type %s. This value must be coerced to a string before using it here.", JSCompiler_inline_result), testStringCoercion(value);
    }
    function disabledLog() {
    }
    function disableLogs() {
    ...
    function defineKeyPropWarningGetter(props, displayName) {
      function warnAboutAccessingKey() {
        specialPropKeyWarningShown || (specialPropKeyWarningShown = true, error("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://react.dev/link/special-props)", displayName));
      }
      warnAboutAccessingKey.isReactWarning = true;
      Object.defineProperty(props, "key", {
        get: warnAboutAccessingKey,
    ...
    function elementRefGetterWithDeprecationWarning() {
      var componentName = getComponentNameFromType(this.type);
      didWarnAboutElementRef[componentName] || (didWarnAboutElementRef[componentName] = true, error("Accessing element.ref was removed in React 19. ref is now a regular prop. It will be removed from the JSX Element type in a future release."));
      componentName = this.props.ref;
      return componentName !== undefined ? componentName : null;
    }
    function ReactElement(type, key, _ref, self, source, owner, props) {
